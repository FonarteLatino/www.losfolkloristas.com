...
$twitter_app_consumer_key = omni_option('twitter_consumer_key');
$twitter_app_consumer_secret = omni_option('twitter_consumer_secret');
$twitter_app_user_token = omni_option('twitter_access_token');
$twitter_app_user_secret = omni_option('twitter_access_token_secret');
