...
if (!$name) $errors[count($errors)] = __('Please enter your name.', 'omni');
if (!$email || !filter_var($email, FILTER_VALIDATE_EMAIL)) $errors[count($errors)] = __('Please enter your email.', 'omni');
if (!$comment) $errors[count($errors)] = __('Please enter your comment.', 'omni'); 
...
if (!$errors) {
	...
	<body>
	<table>
		<tr><td style="padding-right:30px; font-weight:bold;">Name</td><td>' . $name . '</td></tr>
		<tr><td style="padding-right:30px; font-weight:bold;">Email</td><td>' . $email . '</td></tr>
		<tr><td style="padding-right:30px; font-weight:bold;">Comment</td><td>' . nl2br($comment) . '</td></tr>
	</table>
	</body>
	</html>';
