		...
		<div id="vp-option-panel"class="vp-option-panel <?php echo ($set->get_layout() === 'fixed') ? 'fixed-layout' : 'fluid-layout' ; ?>">
			<div class="vp-left-panel">
				...
				<div id="vp-menus" class="vp-menus">
                    ...
                    <div style="display:block; width: 100%; margin-top: 20px" class="social-box">
<a href="https://twitter.com/themeshifters" target="_blank" style="width:23%!important; text-align:center; float:left;"><i class="icon-twitter" style="font-size:18px;"></i></a>
<a href="https://www.facebook.com/pages/ThemeShifters/149860555217189" target="_blank" style="width:23%!important; text-align:center; float:left;"><i class="icon-facebook" style="font-size:18px;"></i></a>
<a href="http://themeshifters.com/support/" target="_blank" style="width:23%!important; text-align:center; float:left;"><i class="icon-comment" style="font-size:18px;"></i></a>
<a href="http://dribbble.com/themeshifters" target="_blank" style="width:23%!important; text-align:center; float:left;"><i class="icon-dribbble" style="font-size:18px;"></i></a>
</div>
				</div>
			</div>
