        ...
        <div class="row">
            <div class="span24">
                ...
                <h2 class="section-title"><?php
					if ( is_day() ) :
						printf( __( 'Daily Archives: %s', 'omni' ), get_the_date() );
					elseif ( is_month() ) :
						printf( __( 'Monthly Archives: %s', 'omni' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'omni' ) ) );
					elseif ( is_year() ) :
						printf( __( 'Yearly Archives: %s', 'omni' ), get_the_date( _x( 'Y', 'yearly archives date format', 'omni' ) ) );
					else :
						_e( 'Archives', 'omni' );
					endif;
				?></h2>
